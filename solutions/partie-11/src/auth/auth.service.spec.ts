...
describe('AuthService', () => {
  ...
  describe('inscrire', () => {
    ...
    // 8.15 : le 409 d'un email déjà inscrit n'est plus l'affaire du service : la traduction du code
    // SQL 23505 est testée dans src/commun/toutes-exceptions.filter.spec.ts.
  });
