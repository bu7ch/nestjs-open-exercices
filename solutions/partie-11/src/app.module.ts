...
@Module({
  imports: [
    ...
    // 11.7 : la connexion de BullMQ à Redis, une fois pour toutes les files. Pas le client REDIS du 10.8 :
    // un worker exige `maxRetriesPerRequest: null`, ce client a 1 (pour échouer vite).
    ...
    ImportsModule,
    // Bonus 11.13 à 11.15 : le webhook de paiement, signé et idempotent.
    WebhooksModule,
