...
import { SanteController } from './commun/sante.controller.js';
...
@Module({
  ...
  controllers: [AppController, SanteController],
  providers: [
    AppService,
...
export class AppModule implements NestModule {
  configure(consumer: MiddlewareConsumer) {
    // 8.4 : un identifiant pour chaque requête ; 8.6 : sauf pour la route de santé.
